...
barplot(missing_data$percent, 
        names.arg = missing_data$column, 
        las = 2,  # Rotate labels
        cex.names = 0.7,  # Smaller font for column names
...
ufc_features <- read.csv("data/ufc_features.csv", stringsAsFactors = FALSE)
