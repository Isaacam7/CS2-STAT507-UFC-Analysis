...
```{r}
plot(na_omit_explained_variance, xlab="# of Principal Component", ylab = "Proportion of Variance Explained", main = "Skree Plot PCA", ylim=c(0,1), type='b', col="blue", pch=19, lty=1, xaxp=c(1,4,3))
...
```{r}
set.seed(507)
imputed.kmeans <- kmeans(imputed_numeric, centers = 3)
```
